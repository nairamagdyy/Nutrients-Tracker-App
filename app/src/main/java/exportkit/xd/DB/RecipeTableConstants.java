...
public class RecipeTableConstants {
    ...
    public String CREATE_RECIPE_TABLE = "CREATE TABLE " + DB_Table + "("
            + DB_col_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + DB_col_IMAGE + " TEXT, " + DB_col_NAME + " TEXT, "
            + DB_col_DESCRIPTION + " TEXT, " + DB_col_INGREDIENTS + " TEXT, " + DB_col_USERID + " INTEGER " +")";
